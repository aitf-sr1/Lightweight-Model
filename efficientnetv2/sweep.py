...
_CONFIGS = {
    "normal":    _make_sweep_cfg("efv2-normal",    SWEEP_PARAMETERS),
    "supercrop": _make_sweep_cfg("efv2-supercrop", SWEEP_PARAMETERS),
    "faceonly":  _make_sweep_cfg("efv2-faceonly",  SWEEP_PARAMETERS),
    "compare":   _make_sweep_cfg("efv2-compare",   SWEEP_PARAMETERS_COMPARE),
}

def _make_train_fn(fixed_mode):
    def train_fn():
        import wandb
...
def main():
    parser = argparse.ArgumentParser(description="WandB sweep EfficientNetV2.")
