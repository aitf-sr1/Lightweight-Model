...
_CONFIGS = {
    "normal":    _make_sweep_cfg("eva-normal",    SWEEP_PARAMETERS),
    "supercrop": _make_sweep_cfg("eva-supercrop", SWEEP_PARAMETERS),
    "faceonly":  _make_sweep_cfg("eva-faceonly",  SWEEP_PARAMETERS),
    "compare":   _make_sweep_cfg("eva-compare",   SWEEP_PARAMETERS_COMPARE),
}
...
def main():
    parser = argparse.ArgumentParser(description="WandB sweep EVA02.")
