...
_CONFIGS = {
    "normal":    _make_sweep_cfg("mv3-normal",    SWEEP_PARAMETERS),
    "supercrop": _make_sweep_cfg("mv3-supercrop", SWEEP_PARAMETERS),
    "faceonly":  _make_sweep_cfg("mv3-faceonly",  SWEEP_PARAMETERS),
    "compare":   _make_sweep_cfg("mv3-compare",   SWEEP_PARAMETERS_COMPARE),
}
...
def main():
    parser = argparse.ArgumentParser(description="WandB sweep MobileNetV3.")
