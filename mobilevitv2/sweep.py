...
_CONFIGS = {
    "normal":    _make_sweep_cfg("mvitv2-normal-crop",  SWEEP_PARAMETERS),
    "supercrop": _make_sweep_cfg("mvitv2-super-crop",   SWEEP_PARAMETERS),
    "faceonly":  _make_sweep_cfg("mvitv2-face-only",    SWEEP_PARAMETERS),
    "compare":   _make_sweep_cfg("mvitv2-compare-all",  SWEEP_PARAMETERS_COMPARE),
}
...
def main():
    parser = argparse.ArgumentParser(description="WandB sweep MobileViTV2.")
