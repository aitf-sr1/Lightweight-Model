# MobileNetV4 — 2D Emotion Classification
...
```
Input [B, 3, 224, 224]
  └─ backbone: mobilenetv4_conv_small atau mobilenetv4_hybrid_medium (timm, global_pool='')
...
|----------------|---------------------------------------------|----------------------|
| `small`        | `mobilenetv4_conv_small.e2400_r224_in1k`    | Default, lebih ringan |
| `medium`       | `mobilenetv4_hybrid_medium.e500_r224_in1k`  | Lebih akurat          |
