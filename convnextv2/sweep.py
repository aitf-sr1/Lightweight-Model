...
_CONFIGS = {
    "normal":    _make_sweep_cfg("cnx2-normal",    SWEEP_PARAMETERS),
    "supercrop": _make_sweep_cfg("cnx2-supercrop", SWEEP_PARAMETERS),
    "faceonly":  _make_sweep_cfg("cnx2-faceonly",  SWEEP_PARAMETERS),
    "compare":   _make_sweep_cfg("cnx2-compare",   SWEEP_PARAMETERS_COMPARE),
}
...
def main():
    parser = argparse.ArgumentParser(description="WandB sweep ConvNeXt V2.")
